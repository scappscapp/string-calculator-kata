...
import { StringCalculator } from "../app/src/stringCalculator.js";
import { NegativeNumbersNotAllowed } from "../app/src/negativeNumberError.js";
...
describe("String calculator", function() {
    describe("Method add", function() {
        ...
        it("does not allow summing negative numbers", function() {
            assert.throw(() => stringCalculator.add("//a\n1\n2a3a4a5\n70a-1\n-20"), NegativeNumbersNotAllowed, "negatives not allowed: -1,-20");
        });
